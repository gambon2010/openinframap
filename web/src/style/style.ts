...
import { TILE_BASE_URL } from '../config.js'
...
const style: StyleSpecification = {
  ...
  sources: {
    ...
    power: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/power/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    petroleum: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/petroleum/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    telecoms: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/telecoms/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    water: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/water/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    solar_heatmap: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/solar_heatmap/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    other_pipeline: {
      type: 'vector',
      tiles: [`${TILE_BASE_URL}/map/other_pipeline/{z}/{x}/{y}.pbf`],
      maxzoom: 17,
      attribution: oim_attribution
    },
    osmose_errors_power: {
